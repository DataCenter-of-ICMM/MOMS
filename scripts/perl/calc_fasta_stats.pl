...
my $usage = << "USAGE";
$program: A perl script for calculate FASTA file statistics
Copyright (C) 2018,2019 Institute of Chinese Materia Medica, China Academy of Chinese Medical Sciences

Usage: $program file.fasta [file2.fasta [...]]

Required options:
  file           One or more FASTA files
...
Example:
	$program sample1.fasta -o fasta_stats.tsv
